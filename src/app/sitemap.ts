...
const STATIC_PATHS: StaticPath[] = [
  ...
  { path: "/ats-resume-vs-job-description", priority: 0.89, changeFrequency: "weekly" },
  { path: "/resume-keywords-explained", priority: 0.89, changeFrequency: "weekly" },
  { path: "/how-recruiters-match-resumes", priority: 0.88, changeFrequency: "weekly" },
  { path: "/why-ats-rejects-good-resumes", priority: 0.88, changeFrequency: "weekly" },
  ...
  { path: "/resume-resources", priority: 0.97, changeFrequency: "weekly" },
  { path: "/glossary", priority: 0.82, changeFrequency: "monthly" },
  { path: "/resume-skills-library", priority: 0.88, changeFrequency: "monthly" },
  { path: "/ats-friendly-fonts", priority: 0.87, changeFrequency: "monthly" },
  { path: "/resume-length-guide", priority: 0.87, changeFrequency: "monthly" },
  { path: "/resume-file-types", priority: 0.87, changeFrequency: "monthly" },
  { path: "/jobscan-alternative", priority: 0.9, changeFrequency: "monthly" },
  { path: "/resumeworded-alternative", priority: 0.9, changeFrequency: "monthly" },
  { path: "/enhancv-alternative", priority: 0.89, changeFrequency: "monthly" },
  { path: "/kickresume-alternative", priority: 0.89, changeFrequency: "monthly" },
  { path: "/teal-alternative", priority: 0.89, changeFrequency: "monthly" },
  { path: "/resumeiq-vs-rezi", priority: 0.88, changeFrequency: "monthly" },
  { path: "/resumeiq-vs-zety", priority: 0.88, changeFrequency: "monthly" },
  { path: "/resumeiq-vs-jobscan", priority: 0.89, changeFrequency: "monthly" },
  { path: "/resumeiq-vs-kickresume", priority: 0.88, changeFrequency: "monthly" },
  { path: "/resumeiq-vs-enhancv", priority: 0.88, changeFrequency: "monthly" },
  { path: "/resume-checker-usa", priority: 0.88, changeFrequency: "monthly" },
  { path: "/resume-checker-uk", priority: 0.87, changeFrequency: "monthly" },
  { path: "/resume-checker-canada", priority: 0.87, changeFrequency: "monthly" },
  { path: "/resume-checker-australia", priority: 0.87, changeFrequency: "monthly" },
  { path: "/resume-checker-germany", priority: 0.86, changeFrequency: "monthly" },
  { path: "/resume-checker-uae", priority: 0.86, changeFrequency: "monthly" },
  { path: "/resume-checker-pakistan", priority: 0.86, changeFrequency: "monthly" },
  { path: "/resume-checker-india", priority: 0.88, changeFrequency: "monthly" },
  { path: "/statistics", priority: 0.9, changeFrequency: "monthly" },
  { path: "/resume-statistics", priority: 0.88, changeFrequency: "monthly" },
  { path: "/ats-statistics", priority: 0.88, changeFrequency: "monthly" },
  { path: "/hiring-statistics", priority: 0.87, changeFrequency: "monthly" },
  { path: "/resume-benchmarks", priority: 0.88, changeFrequency: "monthly" },
  ...
  { path: "/methodology", priority: 0.86, changeFrequency: "monthly" },
  { path: "/disclaimer", priority: 0.72, changeFrequency: "monthly" },
  { path: "/how-resume-analysis-works", priority: 0.84, changeFrequency: "monthly" },
  { path: "/editorial-policy", priority: 0.72, changeFrequency: "monthly" },
  { path: "/review-process", priority: 0.72, changeFrequency: "monthly" },

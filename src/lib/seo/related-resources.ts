...
export const RESOURCE_CATALOG: Record<string, RelatedResourceItem> = {
  ...
  atsResumeCheckerOnline: {
    href: "/ats-resume-checker-online",
    title: "ATS Resume Checker Online",
    description: "Browser-based ATS scan — upload PDF and see extracted text.",
  },
  resumeKeywordCheckerCluster: {
    href: "/resume-keyword-checker",
    title: "Resume Keyword Checker",
    description: "Find missing ATS keywords vs any job posting.",
  },
  atsScoreCheckerCluster: {
    href: "/ats-score-checker",
    title: "ATS Score Checker",
    description: "Resume ATS score bands, compatibility %, and fix order.",
  },
  resumeAnalyzerCluster: {
    href: "/resume-analyzer",
    title: "Resume Analyzer",
    description: "AI section analysis — bullets, summary, skills, checklist.",
  },
  resumeParserCluster: {
    href: "/resume-parser",
    title: "Resume Parser Test",
    description: "See what hiring software extracts from your PDF or DOCX.",
  },
  matchAnalyzer: {
  ...
  resumeiqVsJobscan: {
    href: "/resumeiq-vs-jobscan",
    title: "ResumeIQ vs Jobscan",
    description: "Honest feature comparison — match scoring, parser preview, and privacy.",
  },
  resumeiqVsRezi: {
    href: "/resumeiq-vs-rezi",
    title: "ResumeIQ vs Rezi",
    description: "Compare AI resume tools vs free ATS parse and job match workflow.",
  },
  resumeiqVsZety: {
    href: "/resumeiq-vs-zety",
    title: "ResumeIQ vs Zety",
    description: "Templates vs ATS checker — when each tool fits your application.",
  },
  resumeiqVsKickresume: {
    href: "/resumeiq-vs-kickresume",
    title: "ResumeIQ vs Kickresume",
    description: "Builder vs checker comparison for export-ready PDFs.",
  },
  resumeiqVsEnhancv: {
    href: "/resumeiq-vs-enhancv",
    title: "ResumeIQ vs Enhancv",
    description: "Design-led resumes vs parser diagnostics and keyword match.",
  },
  atsResumeVsJdGuide: {
    href: "/ats-resume-vs-job-description",
    title: "ATS Resume vs Job Description",
    description: "Two-layer guide—ATS check vs job match % with worked example.",
  },
  resumeKeywordsExplainedGuide: {
    href: "/resume-keywords-explained",
    title: "Resume Keywords Explained",
    description: "Keyword types, placement, and match workflow without stuffing.",
  },
  howRecruitersMatchGuide: {
    href: "/how-recruiters-match-resumes",
    title: "How Recruiters Match Resumes",
    description: "ATS search, ranking, and recruiter skim explained.",
  },
  whyAtsRejectsGoodGuide: {
    href: "/why-ats-rejects-good-resumes",
    title: "Why ATS Rejects Good Resumes",
    description: "Qualified but filtered—parse, filters, and keyword gaps.",
  },
  resumeSkillsLibrary: {

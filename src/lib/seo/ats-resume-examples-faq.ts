...
export const atsResumeExamplesFaqItems: FaqItem[] = [
  {
    question: "What is a good ATS resume example?",
    answer:
  ...
  {
    question: "Can I use a two-column resume if it looks professional?",
    answer:
  ...
  {
    question: "Should skills appear as a list or in bullets?",
    answer:
  ...
  {
    question: "How do I check if my resume matches these examples?",
    answer:

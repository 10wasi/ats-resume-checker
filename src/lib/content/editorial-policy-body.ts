...
5. **Transparent methodology** — Scoring rules are published on our [methodology](/methodology) page. We update docs when behavior changes.
...
If you spot an error in a guide or tool description, contact us via the [contact page](/contact). We correct factual mistakes within a reasonable timeframe and note material updates on legal and methodology pages.

...
export const RESOURCE_HUB_TOOLS = [
  { title: "Free ATS Resume Checker", href: "/ats-resume-checker" },
  { title: "Resume Checker Online", href: "/resume-checker" },
  { title: "Resume Score Check", href: "/resume-score-checker" },
  { title: "Resume Review Online", href: "/resume-review" },
  { title: "AI Resume Review", href: "/ai-resume-review" },
  { title: "CV Checker", href: "/cv-checker" },
